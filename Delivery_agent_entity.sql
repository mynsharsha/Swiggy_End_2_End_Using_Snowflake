...
DROP STREAM CLEAN_SCH.delivery_agent_stm;
DROP TABLE CONSUMPTION_SCH.delivery_agent_dim;
...
from (
    select 
        ...
        metadata$file_content_key as _stg_file_md5,
        current_timestamp as _copy_data_ts
    from @"SANDBOX"."STAGE_SCH"."CSV_STG"/delta/delivery-agent/day-02-delivery-agent.csv t
)
file_format = (format_name = 'stage_sch.csv_file_format')
on_error = abort_statement;
