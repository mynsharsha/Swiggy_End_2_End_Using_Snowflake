...
from (
    ...
    from @"SANDBOX"."STAGE_SCH"."CSV_STG"/initial/customer_address_book_initial/customer_address_book_initial.csv t
)
...
from (
    select 
        ...
        metadata$file_content_key as _stg_file_md5,
        current_timestamp as _copy_data_ts
    from @"SANDBOX"."STAGE_SCH"."CSV_STG"/delta/customer_address_book/day-02-customer-address-book.csv t
)
file_format = (format_name = 'stage_sch.csv_file_format')
on_error = abort_statement;
